"""Run object_throw dataset: all 339 objects × 9 IC combos.

Usage:  python3 run_object_throw_dataset.py
"""
import os
import sys
...
if __name__ == "__main__":
    ...
    log = os.path.join(repo, "_output", "object_throw_dataset.log")
